    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/eagleofthenebula">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/sflores16-twu/mltb"><i class="fab fa-github"></i></a>
        <a href="https://t.me/eagleofthenebula"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See MLTB <a href='https://github.com/sflores16-twu/mltb'>at GitHub</a> By <a href='https://github.com/sflores16-twu'>Stephany Flores</a></h1>", content_type="text/html")
